...
// function to get the time-zone by the address
...
// on complete loading of body
// using async-await as async function to fetch api return promise and we need to wait for promise state to change
